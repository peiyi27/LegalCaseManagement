...
const CaseManagementAdmin = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:3001/get-all-cases-admin')
      .then(response => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        if (response.data.success) {
          ...
          const updatedCasesResponse = await axios.get('http://localhost:3001/get-all-cases-admin');
