...
import './CreateMyCaseFormAdmin.css';

const CreateMyCaseFormAdmin= () => {
  ...
  useEffect(() => {
    ...
    .then(response => {
      console.log('Admin Name:', response.data.adminName);
      setStaffNames([response.data.adminName]);  // Assuming staffNames is expected to be an array
    })
    .catch(error => console.error('Error fetching staff name:', error));
  ...
  return (
    <Form className="admin-create-mycase-form" onSubmit={handleSubmit}>
...
export default CreateMyCaseFormAdmin;
